                    ...
                    >
                        <div className="relative">
                            <Combobox.Input
                                ...
                                className="h-12 w-full border-0 bg-transparent p-4 pr-4 text-gray-800 placeholder-gray-400 focus:ring-0 sm:text-sm"
                                placeholder="Buscar..."
                            />
                        </div>
                        ...
                        { proyectosFiltrados.length > 0 && (
                            ...
                            {proyectosFiltrados.map(proyecto =>(
                                <Combobox.Option key={proyecto._id} value={proyecto} className={({active}) => classNames('cursor-default select-none px-4 py-2',active && 'bg-sky-500 text-white')}>
                                {proyecto.nombre}
                                </Combobox.Option>))}
                            </Combobox.Options>
                        )}
